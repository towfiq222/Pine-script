...
//
//@version=6
indicator('BigBeluga - Smart Money Concepts', 'BigBeluga - Smart Money Concepts [1.0.0]', overlay = true, max_bars_back = 5000, max_boxes_count = 500, max_labels_count = 500, max_lines_count = 500, max_polylines_count = 100)
